...
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.TAJIKISTAN;
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.editor;
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.naunehalendlinelisting.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.naunehalendlinelisting.database.CreateTable.DATABASE_NAME;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.MainActivity;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.core.AppInfo;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.databinding.ActivityLoginBinding;
 ...
 /*            countryCode = getCountryCode(this);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.naunehalendlinelisting.ui.SyncActivity.class).putExtra("login", true));
        } else {
