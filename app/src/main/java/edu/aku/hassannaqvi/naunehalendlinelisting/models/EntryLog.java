package edu.aku.hassannaqvi.naunehalendlinelisting.models;

import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.PROJECT_NAME;
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp._EMPTY_;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.BR;
...
public class EntryLog extends BaseObservable implements Observable {
    ...
    /*public void populateMetaForm() {
        ...
        setSysDate(MainApp.Listings.getSysDate());
        setEntryDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH).format(new Date().getTime()));
        setEbCode(MainApp.Listings.getCluster());
