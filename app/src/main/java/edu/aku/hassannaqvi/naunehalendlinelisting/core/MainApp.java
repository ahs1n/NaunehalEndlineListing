package edu.aku.hassannaqvi.naunehalendlinelisting.core;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.BuildConfig;
...
public class MainApp extends Application {
    ...
    public static final String PROJECT_NAME = "naunehalendlinelisting";
