package edu.aku.hassannaqvi.naunehalendlinelisting.ui;

import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.PROJECT_NAME;
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.naunehalendlinelisting.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.R;
import edu.aku.hassannaqvi.naunehalendlinelisting.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.naunehalendlinelisting.database.DatabaseHelper;
import edu.aku.hassannaqvi.naunehalendlinelisting.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.naunehalendlinelisting.models.SyncModel;
import edu.aku.hassannaqvi.naunehalendlinelisting.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.naunehalendlinelisting.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.naunehalendlinelisting.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                // Forms
                uploadTables.add(new SyncModel(TableContracts.ListingsTable.TABLE_NAME));
                try {
                            ...
                            if (method != null) {
                                try {
                                    ...
                                    if (jsonObject.has("error")) {
                                        ...
                                        Object returnValue = method.invoke(db, jsonArray);
                                        insertCount = (int) returnValue;
